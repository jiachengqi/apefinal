...
CapabilityLoader.AddCapability("IR1.2.1", "Define a repeatable risk assessment methodology.", "Security Operations", "Threat Modeling", "Product");
        ...
        CapabilityLoader.AddCapability("SD1.3.2", "Use automated security testing tools in development and testing phases.", "Code Security", "SAST", "Product");
        ...
        CapabilityLoader.AddCapability("SD2.5.1", "Perform penetration testing on all critical systems before deployment.", "Security Operations", "Penetration Testing", "Both");
        CapabilityLoader.AddCapability("SD2.5.2", "Automated security scanning should be integrated into CI/CD pipelines.", "Code Security", "SAST", "Both");
        ...
        CapabilityLoader.AddCapability("SD2.6.2", "Use automated static analysis tools for detecting security issues in code.", "Code Security", "SAST", "Both");
        ...
        CapabilityLoader.AddCapability("BA1.1.3", "Conduct regular application security assessments and penetration testing.", "Security Operations", "Penetration Testing", "Product");
        ...
        CapabilityLoader.AddCapability("BA1.2.3", "Perform regular vulnerability assessments and security testing on web applications.", "Code Security", "SAST", "Product");
        ...
        CapabilityLoader.AddCapability("TS1.6.2", "Enforce encryption policies for data at rest and in transit.", "Data Security", "Encryption", "Both");
        ...
        CapabilityLoader.AddCapability("SY2.2.2", "Establish alerting mechanisms for system performance degradation.", "Platform Security", "SIEM", "Service");
        ...
        CapabilityLoader.AddCapability("BC1.1.3", "Define recovery objectives, including Recovery Time Objectives (RTOs) and Recovery Point Objectives (RPOs).", "Recovery & Resilience", "Disaster Recovery Orchestration", "Product");
